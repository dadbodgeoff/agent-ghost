...
import { getStoredAuthState } from '../background/auth-sync';
        ...
        return `
          <div class="signal-row">
            ...
            <span class="signal-bar" aria-hidden="true">
              <span class="signal-bar-fill" style="width: ${percent}%; background: ${
                data.level >= 3 ? '#f87171' : data.level >= 2 ? '#fbbf24' : '#22c55e'
              }"></span>
            </span>
          </div>
        `;
