<script lang="ts">
  ...
  function applyConvergenceData(convData: { scores?: Array<{ score?: number; level?: number }> } | null | undefined) {
    const latest = convData?.scores?.[0];
