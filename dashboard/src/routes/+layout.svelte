<script lang="ts">
  ...
  onMount(async () => {
    ...
    shortcuts.registerCommand('theme.toggle', () => toggleStoredTheme());
    ...
    if (!runtime.isDesktop() && supportsServiceWorker()) {
  ...
  async function subscribeToPush() {
    ...
    if (!supportsPushNotifications() || !supportsServiceWorker()) return;
