  ...
  {:else if activeTab === 'installed'}
    {#if installed.length === 0}
      <div class="empty-state">
        ...
        <button class="action-btn" type="button" onclick={() => (activeTab = 'available')}>
  ...
  <div class="confirm-overlay" onclick={() => (confirmSkill = null)} role="presentation">
    ...
    >
      ...
      <div class="confirm-actions">
        <button class="cancel-btn" type="button" onclick={() => (confirmSkill = null)}>Cancel</button>
        <button class="approve-btn" type="button" onclick={confirmInstall} disabled={actionLoading === confirmSkill.id}>
...
{#if quarantineSkill}
  <div class="confirm-overlay" onclick={closeQuarantineDialog} role="presentation">
    ...
    >
      ...
      ></textarea>
      <div class="confirm-actions">
        <button class="cancel-btn" type="button" onclick={closeQuarantineDialog}>Cancel</button>
        <button
          type="button"
          class="approve-btn"
